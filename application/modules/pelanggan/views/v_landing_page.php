...
<html lang="en">
  ...
  <div class="site-wrap">
          ...
          <div class="ml-auto w-25">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                <li class="cta"><a href="#contact-section" class="nav-link"><span>Tentang Kami</span></a></li>
              </ul>
            </nav>
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  <h1  data-aos="fade-up" data-aos-delay="100">Bayar Listrik ....!!!</h1>
                  <p class="mb-4"  data-aos="fade-up" data-aos-delay="200">Jangan daftar, karena nggak ada untungnya. Maxime ipsa nulla sed quis rerum amet natus quas necessitatibus.</p>
                  <p data-aos="fade-up" data-aos-delay="300"><a href="#" class="btn btn-primary py-3 px-5 btn-pill">Register</a></p>

                </div>

                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <form method="POST" class="form-box" id="sign_in">
    ...
    <div class="site-section pb-0">
      ...
      <div class="future-blobs">
        <div class="blob_2">
          <img src="<?= base_url()?>assets2/images/blob_2.svg" alt="Image">
        </div>
        <div class="blob_1">
          <img src="<?= base_url()?>assets2/images/blob_1.svg" alt="Image">
        </div>
      </div>
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-7">
            ...
            <h2 class="section-title mb-3">Daftar Sekarang !</h2>
            ...
            <form method="post" data-aos="fade">
              ...
              <div class="form-group row">
               ...
               <div class="form-group row">
                <div class="col-md-12">
                  <input type="text" class="form-control" placeholder="Nomor Kwh">
                </div>
              </div>
             
              <div class="form-group row">
                <div class="col-md-12">
                  <input type="text" class="form-control" placeholder="Tarif / Kwh">
                </div>
              </div>

              <div class="form-group row">
                <div class="col-md-12">
                  <textarea class="form-control" id="" cols="30" rows="10" placeholder="Address"></textarea>
                </div>
              </div>
  ...
  <script type="text/javascript">
      $('#sign_in').submit(function(event){
          ...
          $.ajax({
            url:"<?= base_url()?>pelanggan/C_landing_page/proses_login",
            data:datalogin,
            type:"post",
            dataType:"json",
            success:function(hasil){
                if (hasil['status']==1) 
                {
                    ...
                    setTimeout(function(){
                        location.href="<?= base_url()?>pelanggan/C_dashboard_pelanggan";
                    }, 500);
                }
                else
                {
